 ...
 */
void Menue_process(int newSocket, Graph *graphPtr)
{
    ...
    while (true)
    {
        ...
        case 2:
        { // Add an edge
            std::string Add_edgeRequest = "Provide the edge to add (source, destination, weight): ";
            send(newSocket, Add_edgeRequest.c_str(), Add_edgeRequest.size(), 0);
